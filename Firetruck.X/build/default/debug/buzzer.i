...
const int* melodies[] = { (int*)fur_elise, (int*)rick_roll_test, (int*)deja_vu};
const int melody_lengths[] = {71, 50, 25};
...
int current_song = -1;
const int (*current_melody)[3];
int current_melody_length;
        ...
        if (playing)
        {
            if (is_pause)
            {
                ...
                if (current_note >= current_melody_length)
                {
                    ...
                    PR2 = current_melody[current_note][0];
                    CCPR1L = PR2 >> 4;


                    int duration = current_melody[current_note][1];
                    TMR0 = 65536 - (duration * (8000000 / 4) / 32 / 1000);
                }
                else
                {
            ...
            else
            {
                ...
                TMR0 = 65536 - (pause_time * (8000000 / 4) / 32 / 1000);
            }
        }
    }
}
